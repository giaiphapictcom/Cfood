...
function Admin_Product_ThucHienLuuMoi() {
    ...
    var mDinhLuong1 = CKEDITOR.instances.pUnit1Id.getData();
    var mDinhLuong2 = CKEDITOR.instances.pUnit2Id.getData();
    var mDinhLuong3 = CKEDITOR.instances.pUnit3Id.getData();
    //
    $("#editor1").val(mNoiDung);
    $("#pUnit1Id").val(mDinhLuong1);
    $("#pUnit2Id").val(mDinhLuong2);
    $("#pUnit3Id").val(mDinhLuong3);
...
function Admin_Product_ComeSuaTin(pId) {
    ...
    window.location = "/Product/Edit?pId=" + pId + "";
}
function ThayDoiKieuSanPham(pPage) {
    var pType = $("#pGroupIdHome").val();
    window.location = "/Product/Index?pPage=1&pType=" + pType + "";
}